...
- Сценарий:
  ...
  2. "Подкладывать" сгенерированный CDR в BRT запросом POST http://localhost:8081/processCdrList, CDR файл передавать в теле запроса
  3. Сравнивать код ответа и тело ответа с ожидаемым:
